...
get the app created:
    ...
    $ heroku apps:create chord-tone
    Creating chord-tone... done, stack is cedar
    http://chord-tone.herokuapp.com/ | git@heroku.com:chord-tone.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://chord-tone.herokuapp.com deployed to Heroku

    To git@heroku.com:chord-tone.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://chord-tone.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@chord-tone.herokuapp.com/repl
